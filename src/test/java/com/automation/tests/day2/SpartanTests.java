...
public class SpartanTests {
    ...
    @Test
    @DisplayName("get list of all spartans")  // display name is optional
   ...
   // how to add new spartan?
    ...
    public void deleteSpartanTest(){
        ...
        //we are delete() method to delete something
        ...
        // 400 - always after unsuccessful request and it was YOUR FAULT
